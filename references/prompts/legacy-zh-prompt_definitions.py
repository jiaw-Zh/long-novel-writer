...
# =============== 补齐1：first_chapter_draft_prompt v2 ===================
# 对齐新记忆系统槽位，加体裁模式分支
...
# genre_mode_instructions 的两种填充值：
GENRE_MODE_LITERARY = """\
写作要求（严肃文学模式）：
...
# =============== 补齐2：create_character_state_prompt v2 ===================
# 输出对齐 entities/characters/<slug>.md 结构
...
# =============== 补齐3：chapter_blueprint_prompt v2 ===================
# 加体裁模式，输出格式加 scene_types/emotional_tone/new_facts 字段
...
- 每10章安排1次主角实力展示（让之前看不起主角的人见识）
- 避免连续3章以上无战斗/冲突的纯铺垫章"""

# =============== 补齐4：Character_Import_Prompt v2 ===================
# 输出对齐 entities/characters/<slug>.md 结构
...
# =============== 网文3：opening_three_chapters_prompt ===================
# 开篇三章专用，网文黄金开局结构
...
# =============== 网文4：progression_breakthrough_prompt ===================
# 境界突破章专用提示词
...
# =============== 网文5：golden_finger_design_prompt ===================
# 金手指设计与节奏化使用规则
