...
4. **章节落盘与记忆更新**
   ...
   - 通过后按固定顺序落盘：
     ...
     4. `canon/facts.jsonl` 追加本章约束性事实
     5. `canon/timeline.md` 追加本章时间线事件
     6. `canon/rules.md` 追加/标注本章世界规则
     7. 相关 `entities/*/<slug>.md` 追加「关键节点」+「变更记录」（引用 FACT ID）
     8. 更新实体档案「当前状态」
     9. `foreshadowing-ledger.md` 状态更新
